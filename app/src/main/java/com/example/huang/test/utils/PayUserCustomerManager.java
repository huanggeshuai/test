...
public class PayUserCustomerManager {
    Context context;
    String info;
    ...
    public PayUserCustomerManager(Context context, List<UserCustomActivity> userCustomActivities, FragmentManager fragmentManager) {
    ...
    public void Pay(int position){
        final UserCustomActivity pv=userCustomActivities.get(position);
        User user=new User();
        ...
        payutils.getIstrue(new Payutils.isTrue() {
            ...
            public void istrue(boolean flag) {
                if (flag){
                    JoineditActivityThread(pv.getUserCustomActivityId());
                }else {
