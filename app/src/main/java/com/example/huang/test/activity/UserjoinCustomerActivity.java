...
public class UserjoinCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userjoin_customer);
        init();
    }
    void init(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case StataCode.net_faile:
                    ...
                    Toast.makeText(UserjoinCustomerActivity.this, "网络超时，请重试", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case StataCode.getmore:
                    ...
                    if (dataGrid.getRows().size() == 0) {
                        Toast.makeText(UserjoinCustomerActivity.this, "没有数据了，不要在拉了", Toast.LENGTH_SHORT).show();
                        page = currentpage;
                    }
                    userCustomActivities.addAll(dataGrid.getRows());
                    infofresh.finishRefresh();
